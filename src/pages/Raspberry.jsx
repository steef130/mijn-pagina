...
export const Raspberry = () => {
    ...
    >
     ...
     <GridItem colSpan={2} bg='papayawhip' color='gray.500' padding='10px'	className="story" >
     ...
     <GridItem colSpan={2} bg='papayawhip' className="minecraft" >
     <img src={minecraft}  alt="minecraft" style={{ objectFit: 'cover', width: '100%', height: '100%'  }} ></img>
      </GridItem>
